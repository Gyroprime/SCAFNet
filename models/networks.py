...
from models import HybridModel,HybridModelV2,HybridModelV3,HybridModel_SCM_CTFF,SingalModel_Trans_SCM_CTFF,SingalModel_CNN_SCM_CTFF
...
def get_scheduler(optimizer, args):
    ...
    if args.lr_policy == 'linear':
        ...
        step_size = args.max_epochs // 20
        # args.lr_decay_iters
        # scheduler = lr_scheduler.StepLR(optimizer, step_size=step_size, gamma=0.1)
        scheduler = lr_scheduler.StepLR(optimizer, step_size=step_size, gamma=0.75)
    elif args.lr_policy == 'exponent':
        scheduler = lr_scheduler.ExponentialLR(optimizer,gamma=0.975)
    elif args.lr_policy == 'CosAnn':
...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    elif args.net_G == 'hybrid_model':
        net = HybridModel()
    elif args.net_G == 'hybrid_modelv2':
        net = HybridModelV2()
    elif args.net_G == 'hybrid_modelv3':
        net = HybridModelV3()
    elif args.net_G == 'hybrid_model_scm_ctff':
        net = HybridModel_SCM_CTFF()
    elif args.net_G == 'hybrid_model_scm_ctff_SingleTrans':
        net = SingalModel_Trans_SCM_CTFF()
    elif args.net_G == 'hybrid_model_scm_ctff_SingleCNN':
        net = SingalModel_CNN_SCM_CTFF()
